...
export default function App() {
  ...
  useEffect(() => {
    ...
    try { mq.addEventListener("change", handler); } catch { return; }
  ...
  return (
    ...
    <div style={{ background: C.bg, minHeight: "100vh", color: C.ink, fontFamily: "'IBM Plex Sans', sans-serif" }}>
      {/* Google Fonts — loaded via link to avoid @import blocking on mobile */}
